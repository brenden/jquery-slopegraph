  ...
  $.fn.slopegraph = function() {
    ...
    return this.each(function() {
      ...
      for (var i=0; i<seriesLength; i++) {
        ...
        // If there are only two data points in each series, use a different
        // alignment scheme for the list headings.
        if (seriesLength === 2) {
          $container.addClass(['first', 'last'][i]);
        }

        if (options.omitInteriorLabels && i>0 && i<seriesLength - 1) {
